...
public abstract class UserTask<Params, Progress, Result> {
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link net.thebrent.anycut.UserTask#onPostExecute(Object)} has finished.
         */
        FINISHED,
    }
     ...
     *         {@link net.thebrent.anycut.UserTask.Status#RUNNING} or {@link net.thebrent.anycut.UserTask.Status#FINISHED}.
     */
